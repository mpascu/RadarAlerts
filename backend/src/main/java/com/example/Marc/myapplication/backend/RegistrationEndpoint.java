 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.Marc.example.com", ownerName = "backend.myapplication.Marc.example.com", packagePath = ""))
