 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.eduard.example.com", ownerName = "backend.myapplication.eduard.example.com", packagePath = ""))
